...
const SummeryWidget = () => {
  ...
  return (
    <div className="flex items-center border border-gray-300 rounded-md hover:shadow-xl w-full">
        {/* pie chart contaier */}
    <div className="">
    <StyledEngineProvider injectFirst>
    {/* StyledEngineProvider is used to override the mui provided styles */}
    <Box className="w-48 md:w-full " sx={{ padding: 0, margin: 0 }}>
      <PieChart
        series={[
          {
            data,
    ...
    <div className=" text-gray-600 pr-2  space-y-2 ">
        <h3 className="text-xl text-gray-900 font-bold">This Month</h3>
